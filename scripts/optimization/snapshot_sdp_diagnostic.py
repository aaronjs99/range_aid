"""Event-triggered dense snapshot SDP diagnostic.

This is an educational dense-CVXPY implementation of a lifted RA-SLAM model:
...
diagnostics plus explicit SDP feasibility checks. It is not official CORA and
cannot issue a CORA certificate.
"""
...
def simulate_and_estimate(cfg: SimConfig) -> dict:
    ...
    return {
        ...
        "optimizer": optimizer,
        "optimizer_backend_note": (
            "educational dense snapshot SDP diagnostic; not official CORA; "
            "no artificial target smoothness"
        ),
